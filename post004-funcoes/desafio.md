# SQL na Prática #004 — Funções de Agregação 📊

Seja bem-vindo ao laboratório prático do **Episódio #004**. Neste repositório, você vai praticar o uso das funções de agregação (`COUNT`, `SUM`, `AVG`, `MAX`, `MIN`) direto na fonte de dados, consolidando milhões de registros em respostas estratégicas para o negócio.

O objetivo deste episódio é acabar com o hábito ineficiente de exportar volumes massivos de dados para o Excel apenas para calcular somas e totais.
...
## 💬 Participe!
Conseguiu resolver? Deixe sua query nos comentários do post no LinkedIn e interaja com a comunidade de analistas que dominam dados! 

Se este repositório te ajudou, deixe uma **⭐ Star** para apoiar o projeto!
